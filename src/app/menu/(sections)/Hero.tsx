const Hero = ({ }) => {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(170deg, rgba(0, 0, 0, 0.00) 7.51%, rgba(0, 0, 0, 0.80) 92.93%), url(/images/menu/thepowercouple-0bEl03R6jVY-unsplash.jpg) lightgray 50% / cover no-repeat",
      }}
    >
