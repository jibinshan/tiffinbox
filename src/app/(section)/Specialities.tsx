  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-center justify-center gap-3">
        ...
        <p className="font-jakarta text-4xl font-[100] uppercase tracking-[9px] text-[#9A9A9A]">
          Our Specialties
        </p>
      </div>
      <div className="flex w-full max-w-[1300px] flex-col gap-3 px-3 py-12 md:flex-row md:px-0 md:py-24">
        <div className="flex w-full flex-col items-center justify-center gap-8 md:w-1/4 md:items-end md:justify-center">
          <div className="flex flex-col gap-3 md:items-end md:justify-end">
            <p className="w-full max-w-[200px] font-jakarta font-[500] uppercase text-[#9a9a9a]">
        ...
        <div className="flex aspect-square w-full flex-col items-start justify-start gap-8 rounded-full border-[2px] border-[#282828] bg-[#0b0b0b] md:w-2/4">
          <Image
